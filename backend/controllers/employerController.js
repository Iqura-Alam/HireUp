...
exports.postJob = async (req, res) => {
    try {
        ...
        const { title, description, location, salary_range, expires_at, skill_ids, min_proficiencies } = req.body;

        await pool.query(
            `CALL sp_post_job($1, $2, $3, $4, $5, $6, $7, $8)`,
            [employerId, title, description, location, salary_range, expires_at, skill_ids || [], min_proficiencies || []]
        );
